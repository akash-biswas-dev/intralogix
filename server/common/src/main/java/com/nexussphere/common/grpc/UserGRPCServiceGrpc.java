...
public final class UserGRPCServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.nexussphere.common.grpc.IsUserExistRequest,
      com.nexussphere.common.grpc.IsUserExistResponse> getIsUserExistMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "IsUserExist",
      requestType = com.nexussphere.common.grpc.IsUserExistRequest.class,
      responseType = com.nexussphere.common.grpc.IsUserExistResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.nexussphere.common.grpc.IsUserExistRequest,
      com.nexussphere.common.grpc.IsUserExistResponse> getIsUserExistMethod() {
    io.grpc.MethodDescriptor<com.nexussphere.common.grpc.IsUserExistRequest, com.nexussphere.common.grpc.IsUserExistResponse> getIsUserExistMethod;
      ...
      synchronized (UserGRPCServiceGrpc.class) {
        if ((getIsUserExistMethod = UserGRPCServiceGrpc.getIsUserExistMethod) == null) {
          UserGRPCServiceGrpc.getIsUserExistMethod = getIsUserExistMethod =
              io.grpc.MethodDescriptor.<com.nexussphere.common.grpc.IsUserExistRequest, com.nexussphere.common.grpc.IsUserExistResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "IsUserExist"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.nexussphere.common.grpc.IsUserExistRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.nexussphere.common.grpc.IsUserExistResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void isUserExist(com.nexussphere.common.grpc.IsUserExistRequest request,
        io.grpc.stub.StreamObserver<com.nexussphere.common.grpc.IsUserExistResponse> responseObserver) {
  ...
  public static final class UserGRPCServiceStub
    ...
    /**
     */
    public void isUserExist(com.nexussphere.common.grpc.IsUserExistRequest request,
        io.grpc.stub.StreamObserver<com.nexussphere.common.grpc.IsUserExistResponse> responseObserver) {
  ...
  public static final class UserGRPCServiceBlockingV2Stub
    ...
    /**
     */
    public com.nexussphere.common.grpc.IsUserExistResponse isUserExist(com.nexussphere.common.grpc.IsUserExistRequest request) throws io.grpc.StatusException {
  ...
  public static final class UserGRPCServiceBlockingStub
    ...
    /**
     */
    public com.nexussphere.common.grpc.IsUserExistResponse isUserExist(com.nexussphere.common.grpc.IsUserExistRequest request) {
  ...
  public static final class UserGRPCServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.nexussphere.common.grpc.IsUserExistResponse> isUserExist(
        com.nexussphere.common.grpc.IsUserExistRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_IS_USER_EXIST:
          serviceImpl.isUserExist((com.nexussphere.common.grpc.IsUserExistRequest) request,
              (io.grpc.stub.StreamObserver<com.nexussphere.common.grpc.IsUserExistResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.nexussphere.common.grpc.IsUserExistRequest,
              com.nexussphere.common.grpc.IsUserExistResponse>(
  ...
  private static abstract class UserGRPCServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.nexussphere.common.grpc.UsersProto.getDescriptor();
    }
