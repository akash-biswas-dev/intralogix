...
public final class AccessManagerGRPCServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "access_manager.v1.AccessManagerGRPCService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupRequest,
      com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupResponse> getCreateSecurityGroupMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateSecurityGroup",
      requestType = com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupRequest.class,
      responseType = com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupRequest,
      com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupResponse> getCreateSecurityGroupMethod() {
    io.grpc.MethodDescriptor<com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupRequest, com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupResponse> getCreateSecurityGroupMethod;
      ...
      synchronized (AccessManagerGRPCServiceGrpc.class) {
        if ((getCreateSecurityGroupMethod = AccessManagerGRPCServiceGrpc.getCreateSecurityGroupMethod) == null) {
          AccessManagerGRPCServiceGrpc.getCreateSecurityGroupMethod = getCreateSecurityGroupMethod =
              io.grpc.MethodDescriptor.<com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupRequest, com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateSecurityGroup"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createSecurityGroup(com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupRequest request,
  ...
  public static final class AccessManagerGRPCServiceStub
    ...
    /**
     */
    public void createSecurityGroup(com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupRequest request,
        io.grpc.stub.StreamObserver<com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupResponse> responseObserver) {
  ...
  public static final class AccessManagerGRPCServiceBlockingV2Stub
    ...
    /**
     */
    public com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupResponse createSecurityGroup(com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupRequest request) throws io.grpc.StatusException {
  ...
  public static final class AccessManagerGRPCServiceBlockingStub
    ...
    /**
     */
    public com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupResponse createSecurityGroup(com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupRequest request) {
  ...
  public static final class AccessManagerGRPCServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupResponse> createSecurityGroup(
        com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_SECURITY_GROUP:
          serviceImpl.createSecurityGroup((com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupRequest) request,
              (io.grpc.stub.StreamObserver<com.biswasakashdev.nexussphere.protogen.accessmanager.v1.CreateSecurityGroupResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AccessManagerGRPCServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.biswasakashdev.nexussphere.protogen.accessmanager.v1.AccessManager.getDescriptor();
    }
